            ...
            <div class="card shadow-lg">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-3">
                            <label for="username" class="col-md-4 col-form-label text-md-end">{{ __("messages.Type your username") }}</label>

                            <div class="col-md-6">
                                <input id="username" type="password" class="form-control @error('username') is-invalid @enderror" name="username" {{-- value="{{ old('username') }}" --}} required autofocus>
                                @error('username')
